...
return [
    ...
    'MQinfo'          => [
        'testmq' => array(
            ...
            'base'          => array('host' => '127.0.0.1', 'port' => '5672', 'login' => 'test', 'password' => '123456', 'vhost' => 'tp_mq'),
            'queue'         => array(
                'mq' => array('queue_name' => 'test_name', 'durable' => true, 'auto_delete' => false, 'routingkey' => 'test_key'),
            ),
            'exchange'      => array('exchange_type' => 'direct', 'exchange_name' => 'test_mq', 'durable' => true, 'auto_delete' => false),
            'amqp_ex_type'  => 'direct',
    ...
    'MQlog'           => [
        'sendMQ'        => array(
            'db'     => 'file', //用什么存储
            'base'   => ROOT_PATH . '/runtime/logs/xcmq/',
            'rule'   => array(
